...
starter_kit_blinkenlights_demo = os.path.join(basedir, 'starter_kit_blinkenlights_demo')

for dirpath, dirnames, filenames in os.walk(starter_kit_blinkenlights_demo):
