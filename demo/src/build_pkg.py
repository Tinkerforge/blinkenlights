...
DESCRIPTION = 'Demo for the Starter Kit: Blinkenlights'
NAME = 'Starter Kit: Blinkenlights Demo'

def build_macosx_pkg():
    from setuptools import setup, find_packages

    PWD = os.path.dirname(os.path.realpath(__file__))
    RES_PATH = os.path.join(PWD, 'dist', 'Starter Kit Blinkenlights Demo.app', 'Contents', 'Resources')
    data_files = [
    ...
    plist = dict(
        ...
        CFBundleGetInfoString = ' '.join(['Starter Kit: Blinkenlights Demo', config.DEMO_VERSION]),
...
def build_linux_pkg():
    ...
    f = open('starter_kit_blinkenlights_demo/DEBIAN/control', 'r')
    lines = f.readlines()
    f.close()

    f = open('starter_kit_blinkenlights_demo/DEBIAN/control', 'w')
    for line in lines:
